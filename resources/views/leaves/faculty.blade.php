...
@section('title', 'Faculty Leave Applications | SCSA Attendance')
@section('page-title', 'Faculty Leave Applications')
...
@section('content')
    <div class="grid grid-2">
        ...
        <section class="card">
            ...
            <form method="post" action="{{ route('leaves.faculty.store') }}" enctype="multipart/form-data">
                @csrf
