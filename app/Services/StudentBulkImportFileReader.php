...
class StudentBulkImportFileReader
{
    /**
    ...
    {
        $tempPath = sys_get_temp_dir().DIRECTORY_SEPARATOR.uniqid('students_', true).'.zip';
    ...
    private function finalizeRows(?array $headers, array $rows): array
    {
        ...
        if ($rows === []) {
            throw new RuntimeException('The uploaded file does not contain any student rows.');
        }
    ...
    private function normalizeHeaders(array $headers): array
    {
        return array_map(function ($header) {
            ...
            return match ($normalized) {
                'full_name', 'student_name' => 'name',
                'enrollment', 'enrollment_number', 'enrollment_no', 'enrolment_no', 'enrolment_number' => 'enrollment_no',
                'roll', 'roll_number', 'roll_no' => 'roll_no',
                'user_name', 'login', 'login_username' => 'username',
                'email_address' => 'email',
                'phone', 'mobile_number', 'mobile_no', 'phone_number' => 'mobile',
                'initial_password', 'login_password' => 'password',
                default => $normalized,
            };
        }, $headers);
    }
